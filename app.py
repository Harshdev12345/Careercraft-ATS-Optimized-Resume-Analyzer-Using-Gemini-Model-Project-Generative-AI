...
genai.configure(api_key=os.getenv("AIzaSyAo0_PImZNg_t9ROd4PkeY1tnNF96KaOyk"))
...
st.markdown(
    ...
    img[src="C:\\Users\\HP\\Downloads\\suvansh2\\images\\icon22.jpg"]{
        position:absolute;
        left:-20px;
    }
...
with col1:
    ...
    st.markdown(""" 
                ...
                """, unsafe_allow_html=True)
with col2:
     img1 = Image.open("C:\\Users\\HP\\Downloads\\suvansh2\\images\\image1.jpg")
...
with col2:
    ...
    st.markdown(""" 
                ...
                """, unsafe_allow_html=True)
with col1:
   img2 = Image.open("C:\\Users\\HP\\Downloads\\suvansh2\\images\\image2.jpg")
...
with col2:
    img3 = Image.open("C:\\Users\\HP\\Downloads\\suvansh2\\images\\image3.jpg")
...
video_path = "C:\\Users\\HP\\Downloads\\suvansh2\\Advance Analysis AI Video.mp4"
